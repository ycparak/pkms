<template>
  <div class="challenge">
    ...
    <p><strong>When is the first update?</strong> 1st of August 2021. That will be the introduction update and will probably be about me picking/validating ideas. Updates will come every Sunday.</p>
